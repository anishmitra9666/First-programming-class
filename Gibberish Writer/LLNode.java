...
public class LLNode<T> {
  ...
  public void insertAfter(T element) {
    LLNode<T> currentNext = this.getNext();
    LLNode<T> insertedNode = new LLNode<T>(element, currentNext);
  ...
  public void deleteNext() {
    LLNode<T> twoDown = new LLNode<T>(this.getNext().getNext().getElement(), null);
    LLNode<T> oneDown = new LLNode<T>(this.getNext().getElement(), twoDown);
    if (twoDown != null && oneDown != null) {
      this.setNext(twoDown);
    }
    else {
      this.setNext(null);
    }
